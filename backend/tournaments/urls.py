...
from .views import TournamentUpdateApiView, AnonymousBracketGetView, AnonymousBracketUpdateView, TournamentsAPIList, TournamentAPIView, TournamentCreateView, BracketAPIView, AnonymousBracketCreateView, AllBracketAPIView, TournamentDeleteAPIView, BracketUpdateAPIView, GamesApiView, CreateModeratorAPIView, DeleteModeratorAPIView 
